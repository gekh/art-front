            ...
            >
              <div>
                <div id="edit-account" class="form-wrapper form-group">
                  ...
                  <div class="form-item form-item-mail form-type-textfield form-group">
                    ...
                    <div class="help-block">
                      ...
                      отсылаться на этот адрес. Адрес электронной почты не будет публиковаться и
                ...
                >
                  <label
                    class="control-label"
                    for="edit-fz152-agreement"
                    style="line-height: 1.2; font-weight:normal;"
                  >
                    <input
                      required
                      type="checkbox"
                    ...
                    />
                    Я даю согласие на
                    <a href="/privacy-policy" style="color:#08ade9" target="_blank"
